...
namespace HouseDB.Services.HouseDBApi
{
    ...
    public partial interface IHouseDBAPI : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<IList<P1WeekUsage>>> StatisticsGetP1WeekUsageGetWithHttpMessagesAsync(int amountOfWeeks, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse> TrappersGetThingsGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
