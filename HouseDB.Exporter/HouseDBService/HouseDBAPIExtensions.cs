...
namespace HouseDB.Exporter.HouseDBService
{
    ...
    public static partial class HouseDBAPIExtensions
    {
            ...
            /// </param>
            public static void StatisticsGetMotionDetectionsPost(this IHouseDBAPI operations, PostGetMotionDetections postGetMotionDetections = default(PostGetMotionDetections))
            {
                operations.StatisticsGetMotionDetectionsPostAsync(postGetMotionDetections).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task StatisticsGetMotionDetectionsPostAsync(this IHouseDBAPI operations, PostGetMotionDetections postGetMotionDetections = default(PostGetMotionDetections), CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.StatisticsGetMotionDetectionsPostWithHttpMessagesAsync(postGetMotionDetections, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
